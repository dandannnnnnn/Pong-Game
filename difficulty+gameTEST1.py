...
def on_message(client, userdata, msg):
    ...
    if payload in ["links", "rechts", "hold"]:
        ...
        print(f"Button command received: {payload}")
...
def display_highscores_screen():
    ...
    back_text = button_font.render("Back to menu", True, RED_LIGHT)
...
show_highscores_button = {"text": "Highscores", "rect": pygame.Rect(0, 0, button_width, button_height),
                          "base_text_color": pastel_purple, "action": "show_highscores"}  # "Highscores" text
